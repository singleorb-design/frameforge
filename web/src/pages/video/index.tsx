...
const logStore = createWorkbenchRecordStore("video");
...
export default function VideoPage() {
    ...
    useEffect(() => {
        setStorageScope({ kind: "workbench", ownerId: "video" });
    ...
    const deleteSelectedLogs = async () => {
        ...
        await localApi.cleanupMedia().catch((error) => console.error("清理生成视频失败", error));
        await refreshLogs();
