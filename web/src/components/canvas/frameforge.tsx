...
const PINCH_ZOOM_SENSITIVITY = 15.0;

type FrameForgeCanvasProps = {
...
export function FrameForgeCanvas({ containerRef, viewport, backgroundMode = "lines", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onCanvasDoubleClick, onContextMenu, onDrop, children }: FrameForgeCanvasProps) {
    ...
    useEffect(() => {
        ...
        const releaseSpace = () => setIsSpacePressed(false);
